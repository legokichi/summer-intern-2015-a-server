<?php
    $queries = array(
        ...
        "CREATE TABLE illust( illust_id INTEGER PRIMARY KEY AUTOINCREMENT, title_id INTEGER, user_id INTEGER, user_name TEXT, likes INTEGER, date TEXT, width INTEGER, height INTEGER);",
    ...
    array_map('unlink', glob("img/thumb/*"));
